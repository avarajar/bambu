...
class Producto(models.Model):
    ...
    imagen_principal = models.ImageField(upload_to='imagenes_productos/', null=True, blank=True)
    imagen_dos = models.ImageField(upload_to='imagenes_productos/', null=True, blank=True)
    imagen_tres = models.ImageField(upload_to='imagenes_productos/', null=True, blank=True)
    imagen_cuatro = models.ImageField(upload_to='imagenes_productos/', null=True, blank=True)
